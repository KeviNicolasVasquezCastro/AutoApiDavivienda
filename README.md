...
Se deja codigo que hubiera servido como prueba, sin embargo al no poder avanzar debido a las dificultades tecnicas, no se realizaron mas escenario como consultar usuario inexistente, enviar una peticion vacia, etc.
